<script>
    export default {
        ...
        methods: {
            GetBlog() {
                const blog = this.AllBlogs.find((blog) => blog.url === this.$route.params.singleblog);
            ...
            CommentSubmit(){
                ...
                if (!this.VErrors['name'] && !this.VErrors['email'] && !this.VErrors['comment']) {
                    this.$axios.post('/blogs-comments/',{
        ...
        mounted() {
            setTimeout(()=> {
                ...
                this.BaseUrlImg = this.$axios.defaults.baseURL;
            }, 500)
        }
    }
</script>
            ...
            <div class="container">
                <div class="blog-single-col">
                    ...
                    <div class="blog-comments">
                        ...
                        <template v-for="comments in TotalComments">
                            <div v-if="comments.published" class="blog-comment-box p-4 rounded" :key="comments.id">
                                <ul>
                                    <li>
                                        <h6>{{comments.name}}</h6>
                                    </li>
...
<style scoped>
    ...
    .single-blog-heading {
        background-image: url("@/static/images/BlogComp/BlogComp/top-bg-4.jpeg");
    }
