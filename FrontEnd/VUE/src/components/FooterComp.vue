<script>
    ...
    export default {
        ...
        methods: {
            // Send Data To Server
            SubmitFormToServer() {
                getAPI.post('/email/',{"email": this.VEmail})
                .then(response => {
...
<template>
    <footer class="footer-area footer-black">
                ...
                <div class="col-lg-4 col-md-5">
                    <div class="widget footer-col logo-col">
                        <div class="footer-logo">
                            <img loading="lazy" decoding="async" src="@/assets/images/logo.png" alt="Footer Logo">
                        </div>
        ...
        <div class="cameraman-two-img">
            <img loading="lazy" decoding="async" src="@/assets/images/FooterComp/camera-man-2.png" alt="Camera Man 2">
        </div>
        <div class="cameraman-three-img">
            <img loading="lazy" decoding="async" src="@/assets/images/FooterComp/camera-man-3.png" alt="Camera Man 3">
        </div>
    </footer>
  <router-view />
</template>
